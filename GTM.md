# Go-To-Market (GTM) Strategy — Lumina Audit

## Target User
**The "Overwhelmed CTO" or "Early Stage Founder"**
- **Company Stage**: Seed to Series A (5–50 employees).
- **Pain Point**: They have 15 different AI subscriptions across their engineering, marketing, and product teams. They know they are overspending but don't have 4 hours to audit it manually.
...
- **Metric**: 10% lead capture rate (10 emails).
- **Viral Coefficient**: 0.2 (every 5 users share the results page, bringing 1 new user).
